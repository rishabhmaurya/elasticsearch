...
public class CreateIndexBlockTests extends ElasticsearchIntegrationTest{

    @Test
    public void testBlockCreateIndex() {
        setCreateIndexBlock("false");
        canCreateIndex("oomtest1");

        setCreateIndexBlock("true");
        canNotCreateIndex("oomtest2");
    }
    ...
    private void setCreateIndexBlock(String value) {
        Settings settings = settingsBuilder().put(MetaData.SETTING_CREATE_INDEX_BLOCK, value).build();
